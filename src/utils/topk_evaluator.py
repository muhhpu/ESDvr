...
class TopKEvaluator(object):
    ...
    def evaluate(self, batch_matrix_list, eval_data, is_test=False, idx=0):
        ...
        if len(pos_items) == 610 and metric_dict['recall@5'] >= self.max_mark:
            self.max_mark = metric_dict['recall@5']
            np.savez("/home/team/caoziyi/mmrec-czy/save_data/pos/TEST/data1.npz", pos_items=pos_items, pos_len_list=pos_len_list, topk_index=topk_index)
