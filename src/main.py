...
if __name__ == '__main__':
    ...
    parser.add_argument('--cc','-c', help='name of log')
    ...
    quick_start(model=args.model, dataset=args.dataset, config_dict=config_dict, save_model=True, mg=args.mg,log_name = args.cc)
